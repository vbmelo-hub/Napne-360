...
<header class="module-head"><span class="eyebrow">Cadastros de referência</span><h2>Períodos, categorias e modelos</h2><p>Padronize opções usadas nos registros e nos novos rascunhos.</p></header>@if(message()){<div class="notice" role="status">{{message()}}</div>}
...
`,styles:[`.module-head{margin-bottom:1rem}.module-head h2{margin:.15rem 0}.module-head p{color:var(--ink-600);margin:0}.card{margin-block:1rem}.card h3{margin-bottom:.8rem}.card>p{color:var(--ink-600)}`]})
