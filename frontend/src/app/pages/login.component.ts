...
@Component({
  ...
  template: `
    <section class="login-page" aria-labelledby="login-title">
      <div class="login-story">
        ...
        <div class="story-content"><span class="eyebrow">Acompanhamento educacional inclusivo</span><h1 id="login-title">NAPNE 360</h1><h2>Cuidado pedagógico com contexto e continuidade.</h2><p>Uma central segura para reunir o percurso do estudante, os registros de acompanhamento e os Planos de Ensino Individualizados.</p><div class="connection-map" aria-hidden="true"><span>Estudante</span><i></i><span>Equipe NAPNE</span><i></i><span>Rede pedagógica</span></div></div>
      ...
      <div class="login-panel">
        <form class="login-form" [formGroup]="form" (ngSubmit)="submit()" novalidate>
          ...
          <div class="password-control"><label for="password" class="required">Senha</label><span class="password-field"><input id="password" [type]="showPassword() ? 'text' : 'password'" formControlName="password" autocomplete="current-password"><button class="password-toggle" type="button" (click)="showPassword.set(!showPassword())" [attr.aria-label]="showPassword() ? 'Ocultar senha' : 'Mostrar senha'">{{ showPassword() ? 'Ocultar' : 'Mostrar' }}</button></span></div>
  ...
  `,
  styles: [`
    :host{display:block;min-height:100vh}.login-page{min-height:100vh;display:grid;grid-template-columns:minmax(0,1.1fr) minmax(25rem,.9fr);background:#fff}.login-story{position:relative;overflow:hidden;background:var(--primary-950);color:#fff;padding:clamp(2rem,6vw,5.5rem);display:flex;flex-direction:column;justify-content:space-between}.login-story::before{content:'';position:absolute;width:34rem;height:34rem;border:1px solid rgba(255,255,255,.12);border-radius:50%;right:-15rem;top:-11rem;box-shadow:0 0 0 5rem rgba(255,255,255,.025),0 0 0 10rem rgba(255,255,255,.02)}.login-brand{display:flex;align-items:center;gap:.8rem;color:#fff;text-decoration:none;z-index:1}.story-content{position:relative;z-index:1;max-width:42rem;margin-block:4rem}.story-content .eyebrow{color:#77dcb6}.story-content h1{font-size:clamp(2.8rem,6vw,5.4rem);line-height:.95;letter-spacing:-.055em;margin:.65rem 0 .8rem}.story-content>p{font-size:1.12rem;color:#cde1da;max-width:38rem}.connection-map{display:flex;align-items:center;margin-top:2.5rem;color:#e7f2ee;font-size:.8rem;font-weight:750}.connection-map span{border:1px solid rgba(255,255,255,.2);border-radius:999px;padding:.45rem .7rem}.connection-map i{width:2rem;height:1px;background:#57c79e}.privacy-line{position:relative;z-index:1;color:#a9c9be;font-size:.82rem;margin:0}.login-panel{display:grid;place-items:center;padding:2rem}.login-form{width:min(28rem,100%);display:grid;gap:1.15rem}.login-form h2{font-size:2rem;margin:.2rem 0}.login-form>div>p{color:var(--ink-600)}.password-control{display:grid;gap:.38rem}.password-field{position:relative;display:block}.password-field input{padding-right:5rem}.password-toggle{position:absolute;right:.25rem;top:.25rem;min-height:2.25rem;padding:.3rem .55rem;background:transparent;color:var(--primary-700);font-size:.8rem}.password-toggle:hover{background:var(--primary-50)}.field-error{color:var(--danger);margin-top:-.85rem}.login-submit{width:100%;margin-top:.25rem}.login-help{font-size:.84rem;color:var(--ink-600);border-top:1px solid var(--border);padding-top:1rem}.login-help strong{color:var(--ink-800)}@media(max-width:800px){.login-page{grid-template-columns:1fr}.login-story{min-height:auto;padding:1.5rem}.story-content{margin:3rem 0 2rem}.story-content h1{font-size:2.55rem}.connection-map{display:none}.privacy-line{display:none}.login-panel{padding:2rem 1.25rem 3rem}}
    .story-content h2{font-size:clamp(1.45rem,3vw,2.35rem);line-height:1.15;letter-spacing:-.035em;margin:0 0 1.25rem;max-width:36rem;color:#edf7f3}
  `]
})
